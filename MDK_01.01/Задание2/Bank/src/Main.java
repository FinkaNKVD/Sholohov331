...
public class Main {
    ...
    private void testCashbackScenarios() {
        ...
        // Пополняем счета
        try {
            setPrivateField(basicTest, "balance", 50000.0);
            setPrivateField(premiumTest, "balance", 50000.0);
            setPrivateField(vipTest, "balance", 50000.0);
        } catch (Exception e) {
    ...
    private void testPaymentWithCashback(Account account, double amount, String type) {
        ...
        try {
            ...
            setPrivateField(account, "welcomeBonusReceived", false);
