...
public class Bank {
    ...
    public void fundAccountsForTesting() {
        for (Account account : accounts) {
            try {
                ...
                setAccountBalance(account, 50000.0);
            } catch (Exception e) {
    ...
    private static void setAccountBalance(Account account, double amount) throws ReflectiveOperationException {
        java.lang.reflect.Field balanceField = Account.class.getDeclaredField("balance");
        balanceField.setAccessible(true);
        balanceField.set(account, amount);
    }
